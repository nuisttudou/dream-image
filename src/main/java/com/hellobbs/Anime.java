...
public class Anime {
    ...
    private static final String tablename = "anime.";
    private static final String controllername = "/bbs_anime";
    private static final String controllernamefor2 = "/bbs_anime/";
