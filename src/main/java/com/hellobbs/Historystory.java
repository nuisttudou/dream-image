...
public class Historystory {
    ...
    private static final String tablename = "historystory.";
    private static final String controllername = "/bbs_historystory";
    private static final String controllernamefor2 = "/bbs_historystory/";
