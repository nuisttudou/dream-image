(function(){
    var Main = {
        ...
        showModel: function(){
            ...
            var effectModel = '<li class="e_item"><div class="imgWrapper"><img src="photo/style/image/demo/{pic}.jpg" alt="" />{effect}</div></li>';
            var html = '<li class="e_item"><div class="imgWrapper"><img src="photo/style/image/demo/k0.jpg" alt="" />原图</div></li>';
